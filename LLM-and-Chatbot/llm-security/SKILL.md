...
> **Agent Skill 自身安全**：安装/合并外部 skill 或 MCP 前读 `../../Security-and-Compliance/reverse-skill-router/ops/skill-supply-chain.md`（OWASP AST10 精简）。社区索引见 `../../Security-and-Compliance/reverse-skill-router/references/community-security-skills.md`。

1. `NOW`: 读取 `../../Security-and-Compliance/reverse-skill-router/field-journal/precedent-pentest.md` — 确认本 skill 的操作是已授权的常规操作
