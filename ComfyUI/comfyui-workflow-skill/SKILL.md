...
description: Generate ComfyUI workflow JSON from natural language. 34 built-in templates (SD1.5/SDXL/SD3/FLUX/Wan2.2/HunyuanVideo/LTXV/Mochi/Cosmos), 360+ node definitions, auto model download, LLM integration. Use when creating txt2img, img2img, txt2vid, img2vid, audio, or 3D workflows without manually wiring nodes.
---
