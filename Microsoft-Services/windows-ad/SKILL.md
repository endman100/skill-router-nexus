...
1. `NOW`: 读取 `../../Security-and-Compliance/reverse-skill-router/field-journal/precedent-pentest.md`
...
- `../../Security-and-Compliance/reverse-skill-router/pentest-tools/references/network-attack-defense.md`
- `../../Security-and-Compliance/reverse-skill-router/attack-chain/`
