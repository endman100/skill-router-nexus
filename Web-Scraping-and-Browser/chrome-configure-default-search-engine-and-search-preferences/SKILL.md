...
- `Images/search_engine_settings_surface.jpg`: entry cue for selecting **Search engine** from the left Settings sidebar.
- `Images/search_engine_selection_dialog.jpg`: operation cue for confirming a selected provider in the Search engine modal.
- `Images/manage_search_engines_page.jpg`: operation cue for opening **Manage search engines and site search** from the Search engine page.
- `Images/search_preference_filter_applied.jpg`: verification cue for a downstream results-page filter.
- `Images/google_search_more_settings_menu.jpg`: entry cue for the Google results-page Search Settings menu when the task is about Google Search display preferences.
- `Images/google_search_other_settings_surface.jpg`: cautionary operation cue for the visible controls on Google Search Settings > Other settings.
