...
- `Images/bookmark_save_control.jpg`: normal page state with the toolbar bookmark star available.
- `Images/edit_bookmark_dialog.jpg`: compact "Bookmark added" popover with the Folder dropdown open.
- `Images/bookmark_folder_creation.jpg`: full "Edit bookmark" dialog with the folder tree and new-folder area.
- `Images/bookmark_result_state.jpg`: post-save verification state with the bookmark star active.
