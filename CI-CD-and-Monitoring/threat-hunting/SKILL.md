...
- `../../Security-and-Compliance/reverse-skill-router/malware-analysis/references/yara-sigma-rules.md`
- `../../Security-and-Compliance/reverse-skill-router/digital-forensics/`
