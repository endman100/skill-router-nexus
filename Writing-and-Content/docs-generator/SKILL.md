...
2. `NOW`：读取 `../../Security-and-Compliance/reverse-skill-router/tool-index.md`，校验工具可用性和实际路径
...
- **MUST** 包含 Evidence → Finding → Path 链（见 `../../Security-and-Compliance/reverse-skill-router/ops/evidence-finding-path.md` 与模板 §0）
- **SHOULD** 引用 case `scope.md` / `timeline.md`（`../../Security-and-Compliance/reverse-skill-router/scripts/case-init.ps1`）
