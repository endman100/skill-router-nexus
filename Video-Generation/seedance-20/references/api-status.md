...
confidence: public-source snapshot as of the verification date; ByteDance core capability pages, Runway model/pricing/input/help pages, fal endpoint pages, and the BytePlus pricing shell were rechecked on 2026-07-27, while older per-section dates remain where a claim was not independently refreshed; not a guarantee of access, pricing, model IDs, upload limits, authorization behavior, or regional availability on every surface
...
- Runway's current Models, Pricing, API Changelog, Inputs, and help pages list `seedance2`, `seedance2_fast`, and `seedance2_mini`. The former Seedance-specific developer guide returned 404 on 2026-07-27, so use the live model, pricing, changelog, input, and help pages instead.
...
Primary sources (the arXiv model card and the ByteDance Seed page) state Seedance 2.0's **native output resolution is 480p/720p**. Higher resolutions are **surface-specific, not a model-native guarantee**: Runway's API lists 1080p and 4K for `seedance2`, while its web help surface lists 480p/720p/1080p; fal's model and pricing pages list 1080p even where schema prose still emphasizes 480p/720p. Treat 480p/720p as the baseline capability and any 1080p/2K/4K claim as a per-surface feature to verify per endpoint at call time.

## fal — Authorized Provider, Global *(added 2026-06-10; fields, resolution, and pricing re-verified 2026-07-27)*
...
**Resolution (verified 2026-07-27):** standard model and pricing pages list 480p/720p/**1080p ($0.682/s)**; fast endpoints cap at 720p. Prose and schema sections can lag the live form or pricing table, so verify per endpoint at call time.
**Pricing (verified 2026-07-27; recheck before quoting):** 720p standard $0.3034/s · fast $0.2419/s · 1080p $0.682/s.
...
- **Runway API (verified 2026-07-27):** model ID `seedance2_mini`; text/image/video input modes, 4–15 second duration, 480p/720p output, and 16 credits per second with a 64-credit minimum. Treat these as Runway-specific API terms.
