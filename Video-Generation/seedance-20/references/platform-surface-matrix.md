...
| Runway Seedance 2 | official third-party surface | API/web generation with Seedance 2 model access | Verified 2026-07-27: Runway lists `seedance2`, `seedance2_fast`, and `seedance2_mini`. Its API and web surfaces expose different resolution and pricing lanes, including surface-specific 4K for `seedance2`; recheck model, duration, references, uploads, plan, region, and price before implementation. Treat as Runway behavior, not Volcengine or BytePlus behavior. |
...
| fal | official third-party surface | API generation through fal's Seedance 2.0 endpoints | Verified 2026-07-27: fal documents text-to-video, image-to-video (start image plus optional end image), and reference-to-video, each with a /fast tier, 4-15s or auto duration, six aspect ratios plus auto, and per-second pricing. Current pricing lists $0.3034/s for 720p standard, $0.2419/s for 720p fast, and $0.682/s for 1080p; verify live before quoting. No extend endpoint on this surface. Treat as fal behavior, not Volcengine or BytePlus behavior. |
