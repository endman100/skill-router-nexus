...
def main() -> int:
    ...
    require("preferred_provider=qwen3" in skill and "asr-router" in skill, "Qwen3 ASR Router lock is missing", failures)
    ...
    require("Qwen aligner exposed by `asr-router`" in skill, "Qwen ASR Router alignment is missing", failures)
