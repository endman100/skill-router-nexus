...
| 62 | `Video-Understanding/` | Video Understanding | 此分類涵蓋長短影片的視覺內容理解、時間分段、影片問答、事件與鏡頭定位、電影語言分析、場景檢索及即時串流理解。適用於需要從影片畫面取得可驗證描述、時間戳摘要、運鏡與構圖證據、語意索引或事件警報的場景；純語音轉錄、剪輯、轉碼與影片生成應分別路由至其專屬分類。 |
