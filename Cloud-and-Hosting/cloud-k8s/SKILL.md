...
1. `NOW`: 读取 `../../Security-and-Compliance/reverse-skill-router/field-journal/precedent-pentest.md` — **云/K8s 测试必须书面授权**
...
- `../../Security-and-Compliance/reverse-skill-router/supply-chain-security/` `../../Security-and-Compliance/reverse-skill-router/pentest-tools/`
