...
- [`wemm-embedding`](../LLM-and-Chatbot/wemm-embedding/)：影片 embedding、多模態語意檢索與 RAG。
...
- 視覺語言模型訓練與微調：`AI-Training/`
- 視覺語言模型量化與推論：`AI-Inference-and-Optimization/`
- 視覺語言模型架構：`AI-Models-and-Architecture/`
