...
- `Images/os_query_system_state_in_terminal_prepare_terminal_context.jpg` is relevant only when the Ubuntu desktop is visible and Terminal still needs to be opened or focused.
- `Images/os_query_system_state_in_terminal_run_requested_command.jpg` should be loaded only if the current screen matches that Settings page and you need to reject it as a terminal command-entry state.
- `Images/os_query_system_state_in_terminal_verify_terminal_result.jpg` should be loaded only if the current screen matches that Settings page and you need to reject it as a terminal verification state.
...
Image reference:
- `Images/os_query_system_state_in_terminal_prepare_terminal_context.jpg`
...
Image reference:
- `Images/os_query_system_state_in_terminal_run_requested_command.jpg` only as a negative-match card; it is not a reusable command-entry screenshot.
...
Image reference:
- `Images/os_query_system_state_in_terminal_verify_terminal_result.jpg` only as a negative-match card; it is not a reusable terminal-result screenshot.
