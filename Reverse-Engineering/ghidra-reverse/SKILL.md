...
1. `NOW`: 读取 `../../Security-and-Compliance/reverse-skill-router/field-journal/precedent-reverse.md`
2. `NOW`: 确认需要 **Ghidra**（无 IDA / 偏好开源 / 批量 headless）
3. `NEXT`: 读 `../../Security-and-Compliance/reverse-skill-router/tool-index.md` 查 ghidra / ghidra-mcp 路径
...
- `../../Security-and-Compliance/reverse-skill-router/ida-reverse/` `../../Security-and-Compliance/reverse-skill-router/radare2/` `../../Security-and-Compliance/reverse-skill-router/binary-diff/`
