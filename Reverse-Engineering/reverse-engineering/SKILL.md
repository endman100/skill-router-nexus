...
> 阶段门闩：`references/re-agent-workflow.md`（triage→static→dynamic→synthesis）。社区 RE skill 对照：`../../Security-and-Compliance/reverse-skill-router/references/community-security-skills.md`。
