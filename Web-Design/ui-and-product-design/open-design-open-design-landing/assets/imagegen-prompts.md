...
file as the source of truth. Save as JPEG to `assets/<slot>.jpg`.
...
### `capabilities.jpg` — 1:1 (1024×1024)
...
### `method-1.jpg` … `method-4.jpg` — 1:1 (816×816)
...
### `lab-1.jpg` … `lab-5.jpg` — 3:4 (768×1024)
...
### `work-1.jpg` & `work-2.jpg` — 3:4 (768×1024)
