...
Drop 16 JPEGs matching `assets/image-manifest.json` filenames at
...
from your `inputs.json`, and copy your `<out>/assets/*.jpg` into the
...
└── assets/
    ├── *.jpg                # 16 collage plates (Open Design instance)
